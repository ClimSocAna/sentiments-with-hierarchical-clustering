"""This code is a copy from the BERTopic project (https://github.com/MaartenGr/BERTopic/tree/master)
which is distributed under the MIT license (https://en.wikipedia.org/wiki/MIT_License)."""
